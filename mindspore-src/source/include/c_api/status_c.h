...
typedef enum OH_AI_Status {
  ...
  OH_AI_STATUS_LITE_FILE_ERROR = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -10),       /**< Invalid file. */
  OH_AI_STATUS_LITE_SERVICE_DENY = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -11),     /**< Denial of service. */
  OH_AI_STATUS_LITE_MODEL_REBUILD = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -12),    /**< Model has been built. */

  // Executor error code, range: [-100,-200)
  OH_AI_STATUS_LITE_OUT_OF_TENSOR_RANGE = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -100), /**< Failed to check range. */
  OH_AI_STATUS_LITE_INPUT_TENSOR_ERROR = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -101), /**< Failed to check input tensor. */
  ...
  OH_AI_STATUS_LITE_OP_EXECUTE_FAILURE = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -303), /**< Failed to execution operator. */
  ...
  OH_AI_STATUS_LITE_INFER_INVALID = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -501), /**< Invalid infer shape before runtime. */

  // User input param error code, range: [-600, 700)
  OH_AI_STATUS_LITE_INPUT_PARAM_INVALID = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -600), /**< Invalid input param by user. */
  ...
  OH_AI_STATUS_LITE_AIPP_INFER_ERROR = OH_AI_COMPCODE_LITE | (0x0FFFFFFF & -701), /**<Not support AIPP>  */
} OH_AI_Status;
#ifdef __cplusplus
}
#endif
