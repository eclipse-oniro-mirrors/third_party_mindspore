...
enum StatusCode : uint32_t {
  ...
  // User aipp infer param error code, range: [-700, 800)
  kLiteInputAippNotSupport = kLite | (0x0FFFFFFF & -700), /**< Not support aipp predict. */
  kLiteInputInferError = kLite | (0x0FFFFFFF & -701), /**< Failed Aipp model infer. */
};
