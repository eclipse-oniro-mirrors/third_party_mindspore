...
static inline int ElementOptSubExtNum0NEON(int index, const float *in0, const float *in1, const float alpha, float *out,
                                                      int size) {
  SIMD_F32 vin0_opt = SIMD_MOV_F32(in0[0]);
...
static inline int ElementOptSubExtNum1NEON(int index, const float *in0, const float *in1, const float alpha, float *out,
                                                      int size) {
  SIMD_F32 vin1_opt_ = SIMD_MOV_F32(in1[0]);
  SIMD_F32 valpha = SIMD_MOV_F32(alpha);
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
...
static inline int ElementOptSubIntNum0NEON(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
...
static inline int ElementOptSubIntNum1NEON(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
...
static inline int ElementSubExtNEON(int index, const float *in0, const float *in1, const float alpha, float *out, int size) {
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    SIMD_F32 vin0 = SIMD_LD_F32(in0 + index);
    SIMD_F32 vin1 = SIMD_LD_F32(in1 + index);
    SIMD_F32 valpha = SIMD_MOV_F32(alpha);
...
static inline int ElementSubIntNEON(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    SIMD_EPI32 vin0 = SIMD_LD_EPI32(in0 + index);
    SIMD_EPI32 vin1 = SIMD_LD_EPI32(in1 + index);
