...
static inline int MaxPooling3DAVX(int c_idx, const float *src_batch_ptr, int channel, float *out,
...
static inline int AvgPooling3DAVX(int c_idx, const float *src_batch_ptr, int channel, float *out,
