 ...
 */
#ifndef NNACL_FP32_APPLY_PROXIMAL_GRADIENT_DESCENT_NEON_H_
#define NNACL_FP32_APPLY_PROXIMAL_GRADIENT_DESCENT_NEON_H_
...
static inline int64_t ApplyProximalGradientDescentOptNEON(
