...
static inline int MaxPooling3DSSE(int c_idx, const float *src_batch_ptr, int channel, float *out,
...
static inline int AvgPooling3DSSE(int c_idx, const float *src_batch_ptr, int channel, float *out,
