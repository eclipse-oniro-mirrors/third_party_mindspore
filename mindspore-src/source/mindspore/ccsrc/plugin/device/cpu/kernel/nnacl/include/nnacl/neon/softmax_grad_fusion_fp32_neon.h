 ...
 */
#ifndef MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_NEON_H_
#define MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_NEON_H_
...
static inline int64_t SoftmaxGradFusionOptNEON(int64_t index, const float *a, const float *b,
...
static inline int64_t ElementOptSubMulNEON(int index, const float *in0, const float *in1, float sum,
                                                           float *out, int size) {
