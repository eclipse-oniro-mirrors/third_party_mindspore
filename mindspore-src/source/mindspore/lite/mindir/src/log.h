 ...
 */
#ifndef MINDSPORE_LITE_MINDIR_LOG_H_
#define MINDSPORE_LITE_MINDIR_LOG_H_
...
#define LITE_LOG_HEAR_FILE_REL_PATH "mindspore/lite/mindir/src/log.h"
#endif
...
class LiteLogWriter {
 public:
  LiteLogWriter(const LiteLocationInfo &location, mindspore::lite::LiteLogLevel log_level)
...
#define MSLOG_IF(level)                                                                                  \
  mindspore::lite::LiteLogWriter(mindspore::lite::LiteLocationInfo(LITE_FILE_NAME, __LINE__, __FUNCTION__), level) < \
    mindspore::lite::LiteLogStream()

#define MS_LOG(level) MS_LOG_##level

#define MS_LOG_DEBUG MSLOG_IF(mindspore::lite::LiteLogLevel::DEBUG)
#define MS_LOG_INFO MSLOG_IF(mindspore::lite::LiteLogLevel::INFO)
#define MS_LOG_WARNING MSLOG_IF(mindspore::lite::LiteLogLevel::WARNING)
#define MS_LOG_ERROR MSLOG_IF(mindspore::lite::LiteLogLevel::ERROR)
...
#endif
#endif  // MINDSPORE_LITE_MINDIR_LOG_H_
