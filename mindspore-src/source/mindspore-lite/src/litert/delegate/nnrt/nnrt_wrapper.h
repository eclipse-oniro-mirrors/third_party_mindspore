...
typedef OH_NN_ReturnCode (*NNTensorDescGetDataTypeFunc)(const NN_TensorDesc *tensorDesc, OH_NN_DataType *dataType);
...
namespace mindspore {
  class NNRTWrapper {
    ...
    private:
      ...
      NNTensorDescGetDataTypeFunc nncore_tensordescgetdatatype_func_ = nullptr;
  };
} // namespace mindspore
