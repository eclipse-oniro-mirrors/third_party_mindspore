 ...
 */
// clang-format off
#ifndef MINDSPORE_NNACL_REDUCE_CONCAT_FP32_SIMD_AVX_H_
#define MINDSPORE_NNACL_REDUCE_CONCAT_FP32_SIMD_AVX_H_
...
static inline int Fp32ReduceSumConcatAxisSize16FusionAVX(int index, float *output_data, const float *input_data, int64_t reduce_axis_size) {
...
static inline int Fp32ReduceSumConcatAxisSize32FusionAVX(int index, float *output_data, const float *input_data, int64_t reduce_axis_size) {
...
static inline int Fp32ReduceSumConcatAxisSize64FusionAVX(int index, float *output_data, const float *input_data, int64_t reduce_axis_size) {
  SIMD_F32 zmm00 = SIMD_LD_F32(input_data + 0 * BLOCK_NUM);
  SIMD_F32 zmm01 = SIMD_LD_F32(input_data + 1 * BLOCK_NUM);
...
static inline int Fp32ReduceSumConcatAxisSize128FusionAVX(int index, float *output_data, const float *input_data, int64_t reduce_axis_size) {
  SIMD_F32 zmm00 = SIMD_LD_F32(input_data + 0 * BLOCK_NUM);
  SIMD_F32 zmm01 = SIMD_LD_F32(input_data + 1 * BLOCK_NUM);
  SIMD_F32 zmm02 = SIMD_LD_F32(input_data + 2 * BLOCK_NUM);
  SIMD_F32 zmm03 = SIMD_LD_F32(input_data + 3 * BLOCK_NUM);
