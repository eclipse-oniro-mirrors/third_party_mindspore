 ...
 */
#ifndef MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_SSE_H_
#define MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_SSE_H_
...
static inline int64_t SoftmaxGradFusionOptSSE(int64_t index, const float *a, const float *b,
...
static inline int64_t ElementOptSubMulSSE(int index, const float *in0, const float *in1, float sum,
                                                           float *out, int size) {
