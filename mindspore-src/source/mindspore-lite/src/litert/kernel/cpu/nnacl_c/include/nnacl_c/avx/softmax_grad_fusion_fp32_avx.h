 ...
 */
#ifndef MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_AVX_H_
#define MINDSPORE_NNACL_FP32_SOFTMAX_GRAD_FUSION_AVX_H_
...
static inline int64_t SoftmaxGradFusionOptAVX(int64_t index, const float *a, const float *b,
...
static inline int64_t ElementOptSubMulAVX(int index, const float *in0, const float *in1, float sum,
                                                           float *out, int size) {
