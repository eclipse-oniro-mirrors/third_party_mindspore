...
static inline int ElementOptDivIntNum0SSE(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
...
static inline int ElementOptDivIntNum1SSE(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
...
static inline int ElementDivIntSSE(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    SIMD_EPI32 vin0 = SIMD_LD_EPI32(in0 + index);
    SIMD_EPI32 vin1 = SIMD_LD_EPI32(in1 + index);
