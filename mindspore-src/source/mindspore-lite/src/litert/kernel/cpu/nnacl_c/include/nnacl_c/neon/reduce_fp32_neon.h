...
static inline int64_t ReduceSumByLastAxisNEON(int64_t index, const float *src, float* tmp_sum, int axis_size) {
  SIMD_F32 tmp = SIMD_MOV_F32(0);
...
static inline int64_t ReduceMaxByLastAxisNEON(int64_t index, const float *src, float* tmp_max, int axis_size) {
...
static inline int64_t IntReduceSumNEON(int64_t index, const int32_t *outer_src, int32_t *outer_dst, int inner_size,
  int axis_size) {
  for (int block_max_size = inner_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
...
static inline int64_t IntReduceMeanNEON(int64_t index, const int32_t *outer_src, int32_t *outer_dst, int inner_size,
  int axis_size) {
  for (int block_max_size = inner_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    const int32_t *inner_src = outer_src + index;
    SIMD_EPI32 tmp = SIMD_MOV_EPI32(0);
...
static inline int64_t IntReduceMinNEON(int64_t index, const int32_t *outer_src, int32_t *outer_dst, int inner_size,
  int axis_size) {
  for (int block_max_size = inner_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    const int32_t *inner_src = outer_src + index;
...
static inline int64_t IntReduceMaxNEON(int64_t index, const int32_t *outer_src, int32_t *outer_dst, int inner_size,
  int axis_size) {
  for (int block_max_size = inner_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    const int32_t *inner_src = outer_src + index;
...
static inline int64_t  ReduceSumDim2Axis0NEON(int64_t index, size_t col_size, size_t col_len, size_t row_len, const float *src_data, float *dst_data) {
...
static inline int64_t FloatReduceDeviationNEON(int64_t index, const float *src_data, float mean, size_t size, float *deviation) {
