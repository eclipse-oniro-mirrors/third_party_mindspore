...
static inline int ElementAbsIntNEON(int index, const int32_t *input, int32_t *output, const int element_size) {
  for (int block_max_size = element_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
...
// not support neon
  static inline int ElementCosNEON(int index, const float *input, float *output, const int element_size) {
    for (int block_max_size = element_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
  ...
  static inline int ElementLogNEON(int index, const float *input, float *output, const int element_size) {
    for (int block_max_size = element_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
      SIMD_F32 vin = SIMD_LD_F32(input + index);
...
static inline int ElementMishNEON(int index, const float *input, float *output, const int element_size) {
...
static inline int ElementNegativeIntNEON(int index, const int32_t *input, int32_t *output, const int element_size) {
  for (int block_max_size = element_size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
