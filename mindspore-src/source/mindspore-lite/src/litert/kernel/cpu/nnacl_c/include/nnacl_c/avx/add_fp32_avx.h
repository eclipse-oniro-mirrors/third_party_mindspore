...
static inline int ElementOptAddExtNum0AVX(int index, const float *in0, const float *in1, const float alpha, float *out, int size) {
...
static inline int ElementOptAddExtNum1AVX(int index, const float *in0, const float *in1, const float alpha, float *out, int size) {
...
static inline int ElementOptAddIntAVX(int index, const int32_t *in0, const int32_t *in1, int32_t *out,
                                                     int size) {
...
static inline int ElementAddExtAVX(int index, const float *in0, const float *in1, const float alpha, float *out, int size) {
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
    SIMD_F32 vin0 = SIMD_LD_F32(in0 + index);
    SIMD_F32 vin1 = SIMD_LD_F32(in1 + index);
    SIMD_F32 valpha = SIMD_MOV_F32(alpha);
...
static inline int ElementAddIntAVX(int index, const int32_t *in0, const int32_t *in1, int32_t *out, int size) {
  for (int block_max_size = size - BLOCK_NUM + 1; index < block_max_size; index += BLOCK_NUM) {
