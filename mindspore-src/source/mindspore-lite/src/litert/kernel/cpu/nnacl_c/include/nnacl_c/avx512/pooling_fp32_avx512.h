...
static inline int MaxPooling3DAVX512(int c_idx, const float *src_batch_ptr, int channel, float *out,
...
static inline int AvgPooling3DAVX512(int c_idx, const float *src_batch_ptr, int channel, float *out,
