 ...
 */
#ifndef NNACL_FP32_APPLY_PROXIMAL_GRADIENT_DESCENT_SSE_H_
#define NNACL_FP32_APPLY_PROXIMAL_GRADIENT_DESCENT_SSE_H_
...
static inline int64_t ApplyProximalGradientDescentOptSSE(
