...
static std::once_flag ms_qos_authflag;
}  // namespace
...
InnerContext::~InnerContext() {
  MS_LOG(DEBUG) << "delete InnerContext.";
  ...
  thread_pool_ = nullptr;
  MS_LOG(DEBUG) << "delete InnerContext done.";
}
