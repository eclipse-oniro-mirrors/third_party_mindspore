...
#include <memory>
#include "mindspore/core/ops/auto_generate/gen_lite_ops.h"
#include "mindspore/mindspore/ops/infer/custom.h"
#include "mindspore/mindspore/ops/ops_utils/op_utils.h"
